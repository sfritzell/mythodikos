...
outfile = "/Users/stellafritzell/mythodikos/test-2-25.csv"
...
with open(outfile, 'w') as z:
	...
	# for tag in soup.find_all(re.compile('^l|^p')):
		# text = tag.string # returns all the text contents

	matches = soup.find_all(string=re.compile(r'\bἈταλάντ'))
	print(matches)
